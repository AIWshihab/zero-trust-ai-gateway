...
<body>
  ...
  <script>
    ...
    async function loadRole() {
      ...
      if (!isAdmin) {
        show("Viewer mode: you can browse model readiness, but only admins can onboard or modify models.");
      }
    }
    ...
    function renderModels() {
      ...
      }).join("") || `<div class="hint">${isAdmin ? "No models registered yet. Add one from the form." : "No models are available yet. Ask an admin to register and activate models."}</div>`;
    }
