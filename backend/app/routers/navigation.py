...
def _base_options(is_admin: bool) -> list[dict]:
    options = [
        ...
        },
        {
            ...
            "category": "user",
            "description": "Change your own password and manage account access hygiene.",
            "summary": "Self-service password change for all users with optional admin reset tools.",
            "requires_admin": False,
        },
        {
            "id": "model_compare",
